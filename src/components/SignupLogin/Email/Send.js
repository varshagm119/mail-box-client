...
const Send = () => {
  ...
  const submitHandler = async(e) => {
    ...
    await fetch(`https://mailboxclient-13dea-default-rtdb.firebaseio.com/sentbox/${sender}.json`,
    {
      method: 'POST',
      body: JSON.stringify({
        to: receiver,
    ...
    await fetch(`https://mailboxclient-13dea-default-rtdb.firebaseio.com/inbox/${receiver}.json`,
    {
      method: 'POST',
      body: JSON.stringify({
        sender: sender,
  ...
  return (
    <div className={classes.body}>
      ...
      <div className={classes.editor}>
        ...
        <br />
        <Button onClick={submitHandler}>{ !sending ? "Send" : "Sending..."}</Button>
    </div>
  );
};
